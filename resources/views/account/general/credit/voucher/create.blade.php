...
@section('content')
    <div class="tile">
        <div class="tile-title-w-btn">
            <h3 class="title">Create Credit Voucher</h3>
            <p>
                <a href="{!! route('accounts.credit-vouchers.index') !!}" class="btn btn-primary">View Vouchers</a>
            </p>
        </div>
        <div class="tile-body" id="app-container">
            <form action="{!! route('accounts.credit-vouchers.store') !!}" method="post" id="create-credit-voucher">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <label for="receive-from">Receive From</label>
                        <div class="input-group mb-3">
                            <input type="hidden" name="party_id">
                            <input type="text" :class="{'is-invalid': errors.hasOwnProperty('party_id')}" class="form-control" id="receive-from" name="customer" placeholder="Receive From">
...
@section('footer')
    ...
    <script>
        ...
        $('#create-credit-voucher').transmitData({
            ...
            successCallback: function (response) {
                location.href = '/accounts/credit-vouchers/';
                app.sectors = [];
            }
        });
    </script>
